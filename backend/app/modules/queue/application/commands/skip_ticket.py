"""SkipTicket command (CAPABILITY-003)."""
...
class SkipTicketCommand:
    ticket_id: uuid.UUID


class SkipTicketHandler:
    def __init__(
        self,
    ...
    def handle(self, command: SkipTicketCommand) -> QueueTicketDto:
...
__all__ = ["SkipTicketCommand", "SkipTicketHandler"]
