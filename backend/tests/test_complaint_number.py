...
def test_counter_name_per_unit_month() -> None:
    ...
    assert case_counter_name("TAB", year=2026, month=8) == "cs:TAB:202608"
    assert case_counter_name("TAB", year=2026, month=8) != counter_name(
        "TAB", year=2026, month=8
    )


def test_format_case_number_has_no_cm_prefix() -> None:
    assert format_case_number("TAB", year=2026, month=8, sequence=1) == "TAB-2608-0001"
    assert format_complaint_number("TAB", year=2026, month=8, sequence=1) == (
        "CMTAB-2608-0001"
    )
    assert (
