...
- **DEC-025** CM Target Single SoT + Mode A Complaint Closure — **Accepted** (2026-08-13). Target = CM Aggregate + Case; Foundation = legacy until a separate Retirement follow-up. DEC-020 remains binding for namespaces. Does **not** unlock Mode B, reopen CAP-008, or authorize Foundation deletion. Slices M-025-1…4 executed; Retirement DEC tetap tertutup.
