...
| DTM-D-007 | Organization sync architecture (reference, not SoR di modul) | ADR | ADR-018 v1.0 | Org master milik EP | BOARD-006; Org Sync Profile; org-gap plan; Branch bootstrap `0047_bapenda_branch_master_data` (non-authoritative, Mode A operational data — bukan klaim ownership permanen) | H7, K4, C-B6-3 | POST C-7 | Accepted w/ Conditions |
