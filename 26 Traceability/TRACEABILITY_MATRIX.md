...
| TRC-L-003 | ECMF | BP-002 | BR-002 | FR-003 | API-003 | EVT-002, EVT-003 | TC-003 | Sprint-02 | Planned |
| TRC-L-004 | ECMF | BP-002 | BR-001 | FR-004 | API-004 | EVT-003 | TC-004 | Sprint-02 | Planned |
| TRC-L-005 | CRM | BP-003 | BR-003 | FR-010 | API-010 | — | TC-010 | Sprint-02 | Planned |
| TRC-L-006 | Notification | BP-004 | BR-004 | FR-020 | — | EVT-001, EVT-002 | TC-020 | Sprint-02 | Planned |
...
- `API-005`: GET /v1/cases (paginated list, draft — 07 API Catalog/openapi/drafts/dashboard-queues.v1.draft.yaml)
