...
| `internal-complaints.v1.yaml` | ECMP Pengaduan Internal API | 1.2.5 | 20 |
...
| API-550 | `GET //api/v1/internal/complaints/{complaintId}/export` | Download Pengaduan Internal snapshot PDF |
...
| — | `POST //api/v1/internal/complaints/{complaintId}/withdraw-request` | After Pusat received — branch asks Pusat to withdraw (work at HQ frozen) |
| — | `POST //api/v1/internal/complaints/{complaintId}/withdraw-request/decision` | Any Pusat login (CRO / Staff KaSatPel / KaSatPel / Admin) decides a PENDING withdraw request |
