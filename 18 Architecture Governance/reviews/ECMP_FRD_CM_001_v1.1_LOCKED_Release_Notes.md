...
Implementation planning and detailed design MAY proceed against this FRD. Foundation artifact statuses (BR-CM-CAT-001 Draft, ADR-014/015 Proposed, DEC remapping) remain governed by **OQ-CM-B1-001** and are not upgraded by this LOCK.
...
| §1.1 Document Control | Normative LOCKED SoT language; D-08 recorded; D-01 foundation-gate caveat retained via OQ-CM-B1-001 |
