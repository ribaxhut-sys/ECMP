...
| CAP006-002 | [Time Source Fulfillment Pattern (CAP-006 / FR-030)](./ADR-CAP006-002_Time_Source_Fulfillment_Pattern.md) | 🟢 **Accepted with Conditions** (v0.3.2) — IG-20260823-01 **PASS**; FR-030 eng **AUTHORIZED WITH SCOPE** (in-app + drain; no CAP-005) |
