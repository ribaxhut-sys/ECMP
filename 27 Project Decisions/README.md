...
| **ECMP-MODEA-INT-001** | Pengaduan Internal Journey Contract | **Accepted (Mode A UI)** v0.11 | `/internal/*` copy + gerbang tutup + snapshot PDF (API-550); CRO tidak menutup; **bukan** Dual-SoT WP / bukan ADR |
