...
| CAP-006 | SLA Measurement & Breach Detection (kalkulasi otomatis + EVT-004) | KPI | BP-005 | FR-030; FRD-005 (`ECMP_FRD_KPI_SLA_v0.1.md`) 🔒 **LOCKED** v0.2 (DEC-CAP006-BQ-001) | Planned (Sprint-03; TRC-L-007 Planned; FRD LOCKED B2-16; no FR-030/EVT-004 engine yet) | Performance Owner |
...
| CAP-006 | **Stay Deferred** (engine) · **FRD LOCKED** | FRD-005 LOCKED; Hybrid Accepted; ARC-CAP006-001/002 Accepted; B2-22 ADDITIONAL ARCHITECTURE REQUIRED; B2-23 **FULFILLMENT PATTERN NOT SPECIFIED** (Time Source); concrete Deferred; no FR-030 engine; next = Stay Deferred confirmation / blocker freeze OR wait non-invent fulfillment basis |
...
**Ranked open engineering (post-B2-14):** CAP-006 → CAP-004 → CAP-005. CAP-001/002/003/007 = maintenance only.
