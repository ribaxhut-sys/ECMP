...
| CAP-006 | SLA Measurement & Breach Detection (kalkulasi otomatis + EVT-004) | KPI | BP-005 | FR-030; FRD-005 (`ECMP_FRD_KPI_SLA_v0.1.md`) 🔒 **LOCKED** v0.2 (DEC-CAP006-BQ-001) | Planned / **Stay Deferred** (engine) — TRC-L-007 Planned; FRD LOCKED B2-16; blocker **CAP006-BLK-001** frozen **B2-24**; **FR-030 eng NOT authorized**; no FR-030/EVT-004 engine | Performance Owner |
...
| CAP-006 | **Stay Deferred** (engine) · **FRD LOCKED** · **blocker frozen (B2-24)** | FRD-005 LOCKED; Hybrid Accepted; ARC-CAP006-001/002 Accepted; B2-22 ADDITIONAL ARCHITECTURE REQUIRED; B2-23 **FULFILLMENT PATTERN NOT SPECIFIED**; **B2-24** confirms Stay Deferred + freezes **CAP006-BLK-001**; concrete Deferred; **FR-030 eng NOT authorized**; wait future non-invent fulfillment Accept (or Board invent-authorize) |
...
**Ranked posture (post-B2-14 / B2-24):** CAP-001/002/003/007 = maintenance only. CAP-006 engine = **architecture-gated Stay Deferred** (not an active eng ticket). Deferred portfolio when DoR opens: CAP-004 → CAP-005 (prod engine).
...
- **B2-24 CAP-006 Stay Deferred Confirmation & Blocker Freeze 2026-08-04:** Confirms engine **Stay Deferred**; freezes official blocker **CAP006-BLK-001** (Time Source fulfillment **NOT SPECIFIED**); **FR-030 eng NOT authorized**; corrects obsolete CAP-007 “next eng” PMO language. Evidence: `../deploy/evidence/B2-24_CAP-006_Stay_Deferred_Confirmation_Blocker_Freeze_20260804.md`. No BE/FE/OpenAPI/Event/FRD/BR/scheduler.
